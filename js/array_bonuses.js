...
// 1. Create a function that returns a random day of the week
    ...
    function returnRandomDay(input) {
        return input;
    }
    
    var randomDay = ["Sunday","Monday", "Tuesday", "Wednesday","Thursday", "Friday", "Saturday"];

    randomDay.forEach(function(element) {
        console.log(element);
    });

    for (var i = 0; i < randomDay);
